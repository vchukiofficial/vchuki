  ...
  return (
    <div className="container py-8 md:py-16 max-w-3xl">
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground [&_h2]:text-foreground [&_h2]:text-lg [&_h2]:font-bold [&_h2]:mt-8 [&_h2]:mb-3 [&_p]:leading-relaxed">
        ...
        <p>Products may be returned within 7 days of delivery subject to our <Link href="/refund-policy" className="text-primary hover:underline">Refund & Return Policy</Link>. Items must be unused, unwashed, and in original packaging with tags attached.</p>
